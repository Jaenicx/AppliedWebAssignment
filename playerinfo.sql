...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2019 at 03:43 AM
...
--
-- Table structure for table `esports_players`
--
...
--
-- Dumping data for table `esports_players`
--

INSERT INTO `esports_players` (`player_id`, `f_name`, `l_name`, `gender`, `gamer_tag`, `team_name`, `proficiency_level`, `game`) VALUES
(1, 'jerome', 'morrison', 'Female', 'sdsf', 'sdds', 'Pro', 'saassd'),
(2, 'hi ', 'bye', 'Female', 'sdsf', 'sdds', 'Pro', 'saassd'),
(3, 'jerry', 'enuh', 'male', 'jerryenuh', 'team awesome', 'pro', 'paladins'),
(4, 'jerry', 'enuh', 'male', 'jerryenuh', 'team awesome', 'pro', 'paladins'),
(5, 'Ariane', 'James', 'Female', 'ariijay', 'GWG', 'Pro', 'Fortnite (because she has no lif');
...
INSERT INTO `tablepaginate` (`ID`, `FirstName`, `Gender`, `GamerTag`, `TeamName`, `ProficiencyLevel`, `Game`) VALUES
...
--
-- Indexes for table `esports_players`
--
ALTER TABLE `esports_players`
...
--
-- AUTO_INCREMENT for table `esports_players`
--
ALTER TABLE `esports_players`
